	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) 
	 	throws Exception{
			...
			member.setMEMBER_EMAIL(request.getParameter("MEMBER_EMAIL"));
	   		...
	   		System.out.println("패스워드 : " + request.getParameter("MEMBER_PW"));
	   		System.out.println("이름 : " + request.getParameter("MEMBER_NAME"));
	   		System.out.println("나이 : " + request.getParameter("MEMBER_AGE"));
	   		System.out.println("성별 : " + request.getParameter("MEMBER_GENDER"));
	   		System.out.println("이메일 : " + request.getParameter("MEMBER_EMAIL"));
