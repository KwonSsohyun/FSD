		...
		<div class="col-md-4 col-md-offset-4">
			...
			<form class="form-signin" action="login.do" method="post">
				<div class="form-group">
					...
					<input	type="inputUserName" class="form-control" placeholder="ID" name="id" required autofocus>
				</div>
				<div class="form-group">
					<label for="inputPassword" class="sr-only">비밀번호</label> 
					<input 	type="inputPassword" class="form-control" placeholder="password" name="password" required>
				</div>
