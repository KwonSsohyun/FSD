...
<body>
	...
	<div class="container">
	  ...
	  <form action="login.do" method="post">
	    ...
	    <div class="form-group">
	      <label for="pw"><spring:message code="message.user.login.password" /></label>
	      <input type="text" class="form-control" id="pw" placeholder="password 입력" name="password" value="${userVO.password}">
	    </div>
	
		<div class="sd">
		    <button type="submit" class="btn btn-info bn">
				<spring:message code="message.user.login.loginBtn" />
			</button>
		</div>
	  </form>
	</div>
