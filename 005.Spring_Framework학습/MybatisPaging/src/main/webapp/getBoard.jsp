	  ...
	  <form action="updateBoard.do" method="post">
        ...
        <table class="table table-bordered">
          <thead>
            ...
            <tr>
            <tr>
              <th class="col-md-3 table-info">파일보기</th>
              <td><a href="./img/${board.filename}" target="_blank">${board.filename}</a><a href="download.do"> 이미지 다운로드</a></td> <!-- <img src="./img/${board.filename}"> -->
